...
export default function About(props) {
  ...
  <h3><li>Andrea's Bio:</li></h3>
  <h4><li>Andrea is a Software Engineer Fellow with a strong background in technical customer service.</li></h4>
  <h3><li>Marsallis' Bio:</li></h3>
  <h4>Marsallis is a Software Engineer who is strong-willed, determined, team-oriented, focused and willing to learn. M passion for development stems from helping others, especially my family- to help grow their businesses into successful modern day corporations. Marsallis fell in love with development once he realized he had all the tools to set other people up for success and to be able to see a smile on someone's face, as they see an application or a website customizable and personable to them.</h4>
  <h3><li>Ryan's Bio</li></h3>
